...
# access to the cluster can point their opencode at it.
#
...
# model (and your cluster's GPU-hours). Share the key privately, and remember
# exposing university HPC compute externally may breach your site's
# acceptable-use policy — check with your admins.
